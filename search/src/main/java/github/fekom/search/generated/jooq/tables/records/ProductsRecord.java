...
public class ProductsRecord extends UpdatableRecordImpl<ProductsRecord> implements Record9<String, String, String, BigDecimal, Integer, String, LocalDateTime, LocalDateTime, String> {
    ...
    @Override
    public Row9<String, String, String, BigDecimal, Integer, String, LocalDateTime, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public ProductsRecord value7(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public ProductsRecord values(String value1, String value2, String value3, BigDecimal value4, Integer value5, String value6, LocalDateTime value7, LocalDateTime value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProductsRecord(String id, String name, String description, BigDecimal price, Integer stock, String category, LocalDateTime createdAt, LocalDateTime updatedAt, String tags) {
        super(Products.PRODUCTS);
